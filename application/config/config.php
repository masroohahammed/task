...
$config['csrf_exclude_uris'] = array(
    ...
    'worksheet/save',
    'hr/reset_password/[0-9]+',
    'hr/toggle_status/[0-9]+',
    'hr/send_notification',
    'discussions/post',
    'discussions/delete/[0-9]+',
    'discussions/get_new/[0-9]+',
    'chat/send',
    'chat/heartbeat',
    'chat/direct/[0-9]+',
    'chat/messages',
    ...
    'chat/user_list',
    'chat/session/[0-9]+',
    'chat/day_session/[0-9]+',
    'clients/add_user/[0-9]+',
    'clients/remove_user/[0-9]+',
    'clients/reset_password/[0-9]+',
    'clients/save_user_projects/[0-9]+',
    'clients/user_projects/[0-9]+',
    'client-portal/add_user',
    'client-portal/remove_user/[0-9]+',
    'client-portal/reset_password/[0-9]+',
    'client-portal/save_user_projects/[0-9]+',
    'client-portal/user_projects/[0-9]+',
);
